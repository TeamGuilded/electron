...
const saveDialog = (sync, window, options) => {
  ...
  if (typeof okButtonLabel !== 'string') throw new TypeError('Confirmation button label must be a string')
  if (typeof cancelButtonLabel !== 'string') throw new TypeError('Cancellation button label must be a string')
  ...
  const settings = { okButtonLabel, cancelButtonLabel, defaultPath, filters, title, message, securityScopedBookmarks, nameFieldLabel, showsTagField, window }
...
const openDialog = (sync, window, options) => {
  ...
  const settings = { title, okButtonLabel, cancelButtonLabel, defaultPath, filters, message, securityScopedBookmarks, window }
