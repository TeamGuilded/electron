...
const delegate = {
  isCommandIdChecked: (menu, id) => menu.commandsMap[id]?.checked,
  isCommandIdEnabled: (menu, id) => menu.commandsMap[id]?.enabled,
  shouldCommandIdWorkWhenHidden: (menu, id) => menu.commandsMap[id]?.acceleratorWorksWhenHidden,
  isCommandIdVisible: (menu, id) => menu.commandsMap[id]?.visible,
  ...
  shouldRegisterAcceleratorForCommandId: (menu, id) => menu.commandsMap[id]?.registerAccelerator,
