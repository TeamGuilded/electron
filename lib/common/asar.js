...
(function () {
  ...
  const overrideAPISync = function (module, name, pathArgumentIndex, fromAsync) {
    ...
    const func = function () {
      ...
      if (!isAsar) return reflectApply(old, this, arguments)
      ...
      return reflectApply(old, this, arguments)
    }
    if (fromAsync) {
      return func
    }
  ...
  const overrideAPI = function (module, name, pathArgumentIndex) {
    ...
    module[name] = function () {
      ...
      if (typeof callback !== 'function') {
        return reflectApply(overrideAPISync(module, name, pathArgumentIndex, true), this, arguments)
      }
  ...
  const makePromiseFunction = function (orig, pathArgumentIndex) {
    return function (...args) {
      ...
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(orig, this, args)
      ...
      return reflectApply(orig, this, args)
    }
  }
  ...
  exports.wrapFsWithAsar = fs => {
    ...
    const wrapRealpathSync = function (realpathSync) {
      return function (pathArgument, options) {
        const { isAsar, asarPath, filePath } = splitPath(pathArgument)
        if (!isAsar) return reflectApply(realpathSync, this, arguments)
    ...
    const wrapRealpath = function (realpath) {
      return function (pathArgument, options, callback) {
        const { isAsar, asarPath, filePath } = splitPath(pathArgument)
        if (!isAsar) return reflectApply(realpath, this, arguments)
    ...
    fs.access = function (pathArgument, mode, callback) {
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(access, this, arguments)
    ...
    fs.accessSync = function (pathArgument, mode) {
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(accessSync, this, arguments)
    ...
    fs.readFile = function (pathArgument, options, callback) {
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(readFile, this, arguments)
    ...
    fs.readFileSync = function (pathArgument, options) {
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(readFileSync, this, arguments)
    ...
    fs.readdir = function (pathArgument, options, callback) {
      ...
      if (!isAsar) return reflectApply(readdir, this, arguments)
    ...
    fs.readdirSync = function (pathArgument, options) {
      const { isAsar, asarPath, filePath } = splitPath(pathArgument)
      if (!isAsar) return reflectApply(readdirSync, this, arguments)
    ...
    function invokeWithNoAsar (func) {
      return function () {
        ...
        process.noAsar = true
        try {
          return reflectApply(func, this, arguments)
        } finally {
