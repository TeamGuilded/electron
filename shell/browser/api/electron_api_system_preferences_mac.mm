...
v8::Local<v8::Value> SystemPreferences::GetUserDefaultForSuite(
    const std::string& suite,
    const std::string& key,
    const std::string& type) {
  base::scoped_nsobject<NSUserDefaults> defaults([[NSUserDefaults alloc]
      initWithSuiteName:base::SysUTF8ToNSString(suite)]);
  return GetUserDefaultImpl(isolate(), defaults, key, type);
}
...
void SystemPreferences::SetUserDefaultForSuite(const std::string& suite,
                                               const std::string& key,
                                               const std::string& type,
                                               gin_helper::Arguments* args) {
  base::scoped_nsobject<NSUserDefaults> defaults([[NSUserDefaults alloc]
...
void SystemPreferences::RemoveUserDefaultForSuite(const std::string& suite,
                                                  const std::string& key) {
  base::scoped_nsobject<NSUserDefaults> defaults([[NSUserDefaults alloc]
      initWithSuiteName:base::SysUTF8ToNSString(suite)]);
  [defaults removeObjectForKey:base::SysUTF8ToNSString(key)];
